...
public class StrategyMetaController {
    ...
    public List<ComponentDescriptor> inspectionRules() {
        return registry.descriptors(InspectionRule.class);
    }

    @GetMapping("/putaway-methods")
    public List<ComponentDescriptor> putawayMethods() {
        return registry.descriptors(PutawayMethod.class);
    }
