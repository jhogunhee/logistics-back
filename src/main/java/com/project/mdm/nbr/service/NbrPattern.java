 ...
 * validate()는 저장 전 입력값 검증(NbrRuleSaveRequest · 미리보기가 쓴다), render()는 조립을 담당한다.
 * NONE은 경계가 하나(접두어→SEQ)뿐이라 prfxDlmt만 쓰고, 날짜 기반 유형은
 * 접두어-날짜 사이에 prfxDlmt, 날짜-SEQ 사이에 deDlmt를 각각 쓴다.
 */
public final class NbrPattern {
    ...
    public static void validate(String prfx, String prfxDlmt, String deDlmt, Integer seqDgt, DyncKyTyp dyncKyTyp) {
