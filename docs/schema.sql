...
COMMENT ON COLUMN stgy_rvsn.snpsht   IS '정의 전체(헤더+하위 구성)의 JSON 직렬화. 구조는 docs/st/전략_테이블설계서.md §8.1';
...
COMMENT ON COLUMN stgy_exec_log.dcsn_trc IS '건별 판정 상세(라인×규칙 / 단계×후보). 구조는 docs/st/전략_테이블설계서.md §8.2. 관리 화면의 "왜 차단/배정됐나" 표의 원본';
