-- =====================================================================
-- WMS 스키마 DDL (PostgreSQL / Supabase)
--   원본: docs/schema.sql (Oracle DDL). 타입/문법만 PostgreSQL로 변환한 파생 파일.
--   변환 규칙:
--    - NUMBER(19) IDENTITY PK  → BIGINT GENERATED BY DEFAULT AS IDENTITY
--    - NUMBER(19)/NUMBER(12)   → BIGINT (id, version, 수량)
--    - NUMBER(5)               → INTEGER (shelf_life_days, pick_prty, sort_ord)
--    - NUMBER(3)               → SMALLINT (outb_life_rate)
--    - VARCHAR2                → VARCHAR
--    - SYSTIMESTAMP            → CURRENT_TIMESTAMP
--    - COMMENT ON / CREATE SEQUENCE / CREATE INDEX / CHECK 는 Oracle과 동일 문법이라 변경 없음
--
...
CREATE TABLE sku (
    sku_id          BIGINT          GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    sku_cd          VARCHAR(30)     NOT NULL,
    sku_nm          VARCHAR(100)    NOT NULL,
...
CREATE TABLE loc (
    ...
    pick_prty       INTEGER         DEFAULT 0 NOT NULL,
    created_at      TIMESTAMP       DEFAULT CURRENT_TIMESTAMP NOT NULL,
    created_by      VARCHAR(30)     DEFAULT 'admin' NOT NULL,
    updated_at      TIMESTAMP,
    updated_by      VARCHAR(30),
...
CREATE TABLE code_detail (
    ...
    sort_ord    INTEGER         DEFAULT 0 NOT NULL,
...
CREATE TABLE ib_line (
    ...
    ptwy_qty    BIGINT          DEFAULT 0 NOT NULL,
    created_at  TIMESTAMP       DEFAULT CURRENT_TIMESTAMP NOT NULL,
    created_by  VARCHAR(30)     DEFAULT 'admin' NOT NULL,
    updated_at  TIMESTAMP,
    updated_by  VARCHAR(30),
...
CREATE TABLE inv (
    ...
    alloc_qty   BIGINT          DEFAULT 0 NOT NULL,
...
CREATE TABLE inv_hist (
    ...
    lot_id       BIGINT         NOT NULL,
    qty          BIGINT         NOT NULL,
    ref_doc_type VARCHAR(10),
    ref_doc_no   VARCHAR(30),
    ib_line_id   BIGINT,
    from_loc_id  BIGINT,
    to_loc_id    BIGINT,
    cancels_inv_hist_id BIGINT,
    created_at   TIMESTAMP      DEFAULT CURRENT_TIMESTAMP NOT NULL,
    created_by   VARCHAR(30)    DEFAULT 'admin' NOT NULL,
    updated_at   TIMESTAMP,
    updated_by   VARCHAR(30),
