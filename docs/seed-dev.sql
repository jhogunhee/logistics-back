...
INSERT INTO loc (loc_cd, zon_cd, tmp_zon, loc_typ, pikng_prty) VALUES ('SHIP-STAGE',  'SHIP-STAGE','DRY', 'STAGE',   0);
INSERT INTO loc (loc_cd, zon_cd, tmp_zon, loc_typ, pikng_prty) VALUES ('DRY-A-01-01', 'DRY',       'DRY', 'STORAGE', 1);
INSERT INTO loc (loc_cd, zon_cd, tmp_zon, loc_typ, pikng_prty) VALUES ('DRY-A-01-02', 'DRY',       'DRY', 'STORAGE', 2);
INSERT INTO loc (loc_cd, zon_cd, tmp_zon, loc_typ, pikng_prty) VALUES ('DRY-A-02-01', 'DRY',       'DRY', 'STORAGE', 3);
INSERT INTO loc (loc_cd, zon_cd, tmp_zon, loc_typ, pikng_prty) VALUES ('DRY-B-01-01', 'DRY',       'DRY', 'STORAGE', 4);
INSERT INTO loc (loc_cd, zon_cd, tmp_zon, loc_typ, pikng_prty) VALUES ('CHL-A-01-01', 'CHL',       'CHL', 'STORAGE', 1);
INSERT INTO loc (loc_cd, zon_cd, tmp_zon, loc_typ, pikng_prty) VALUES ('CHL-A-01-02', 'CHL',       'CHL', 'STORAGE', 2);
INSERT INTO loc (loc_cd, zon_cd, tmp_zon, loc_typ, pikng_prty) VALUES ('CHL-B-01-01', 'CHL',       'CHL', 'STORAGE', 3);
INSERT INTO loc (loc_cd, zon_cd, tmp_zon, loc_typ, pikng_prty) VALUES ('FRZ-A-01-01', 'FRZ',       'FRZ', 'STORAGE', 1);
INSERT INTO loc (loc_cd, zon_cd, tmp_zon, loc_typ, pikng_prty) VALUES ('FRZ-A-01-02', 'FRZ',       'FRZ', 'STORAGE', 2);
INSERT INTO loc (loc_cd, zon_cd, tmp_zon, loc_typ, pikng_prty) VALUES ('DRY-B-01-02', 'DRY',       'DRY', 'STORAGE', 5);
INSERT INTO loc (loc_cd, zon_cd, tmp_zon, loc_typ, pikng_prty) VALUES ('DRY-C-01-01', 'DRY',       'DRY', 'STORAGE', 6);
INSERT INTO loc (loc_cd, zon_cd, tmp_zon, loc_typ, pikng_prty) VALUES ('CHL-B-01-02', 'CHL',       'CHL', 'STORAGE', 4);
INSERT INTO loc (loc_cd, zon_cd, tmp_zon, loc_typ, pikng_prty) VALUES ('FRZ-B-01-01', 'FRZ',       'FRZ', 'STORAGE', 3);
INSERT INTO loc (loc_cd, zon_cd, tmp_zon, loc_typ, pikng_prty) VALUES ('FRZ-B-01-02', 'FRZ',       'FRZ', 'STORAGE', 4);
...
UPDATE loc SET max_qty = 300  WHERE loc_typ = 'STORAGE' AND pikng_prty = 1;

-- 벤더 (입고 거래처). 코드는 VendorService의 채번 규칙(VD-0001)을 따른다.
INSERT INTO vendor (vndr_cd, vndr_nm, pic_nm, tel_no) VALUES ('VD-0001', '서울식품',       '김상현', '02-1234-5601');
INSERT INTO vendor (vndr_cd, vndr_nm, pic_nm, tel_no) VALUES ('VD-0002', '콜드체인프레시', '이정민', '031-555-0102');
INSERT INTO vendor (vndr_cd, vndr_nm, pic_nm, tel_no) VALUES ('VD-0003', '대한물류',       '박도현', '02-9876-5403');
INSERT INTO vendor (vndr_cd, vndr_nm, pic_nm, tel_no) VALUES ('VD-0004', '한마음유통',     '최유진', '031-777-0204');
INSERT INTO vendor (vndr_cd, vndr_nm, pic_nm, tel_no) VALUES ('VD-0005', '그린푸드',       '정성호', '02-4321-0505');
-- 거래 종료 벤더 1건 — 신규 주문 벤더 선택에서 걸러지는지 확인용
INSERT INTO vendor (vndr_cd, vndr_nm, pic_nm, tel_no, us_yn) VALUES ('VD-0006', '옛거래처식자재', '한지훈', '02-1111-2222', 'N');
...
copied AS (
    ...
    SELECT a.ib_order_id, l.prod_id, l.odr_qty
    FROM new_asn a
